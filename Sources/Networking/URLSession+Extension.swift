...
extension URLSession {
    ...
    func request<T:Codable>(_ endpoint: Endpoint, headers: [String: String] = [:], cachePolicy: URLRequest.CachePolicy = .useProtocolCachePolicy, timeoutInterval: TimeInterval = 60.0,completionHandler: @escaping (Result<T, NetworkError>) -> Void) {
